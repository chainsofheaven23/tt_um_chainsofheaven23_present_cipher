...
async def crypto_test_with_assertions(dut):
    ...
    test_cases = [
        ...
        {"ui": 0xF7, "key": 0b101011, "start": 1, "ed": 0, "expected": 0x92}, # Dec 3
        {"ui": 0xD2, "key": 0b110110,  "start": 1, "ed": 0, "expected": 0xA7}, # Dec 4
        {"ui": 0xA7, "key": 0b100011,  "start": 1, "ed": 0, "expected": 0x3C}, #Dec 5
    ]
